...
class profiles::postgresqlha_nodeb(
  ...
  file { '/etc/repmgr/9.4/repmgr.conf':
    ...
    source => "/vagrant/puppet-control/site/profiles/files/postgres_repmgr_nodeb.conf",
  }

  file { '/etc/keepalived/keepalived.conf':
    ensure => file,
    source => "/vagrant/puppet-control/site/profiles/files/postgres_keepalived_nodeb.conf",
  } 
